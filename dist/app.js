...
const parseAndValidateParamId = (req, res) => {
...
app.post('/students', validateBody(createStudentSchema), (req, res) => {
...
app.put('/students/:id', validateBody(updateStudentSchema), (req, res) => {
...
app.patch('/students/:id', validateBody(patchStudentSchema), (req, res) => {
    const currentId = parseAndValidateParamId(req, res);
    if (currentId === null)
        return;
    const { id: newId, name } = req.body;
