        ...
        try {
            switch (answer.trim()) {
                case "1":
                    rl.question("Enter student name: ", (name) => {
                        try {
                            ...
                            console.log("Success: Added student '" +
                                newStudent.name +
                                "' with ID #" +
                                newStudent.id +
                                "!");
                ...
                case "4":
                    rl.question("Enter student ID to delete: ", (idInput) => {
                        try {
                            ...
                            console.log("Success: Removed student '" + removed[0].name + "'!");
                        }
                        catch (err) {
                            if (err instanceof Error)
                                console.log("\nError: " + err.message);
                ...
                case "5":
                    ...
                    break;
                default:
                    throw new Error("Invalid option! Please select a number between 1 and 5.");
            }
        }
        catch (error) {
